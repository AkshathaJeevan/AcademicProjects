...
<head>
	...
	<script type="text/javascript" src="/jquery/jquery.js"></script>
   	<script type="text/javascript" src="/jadrn019/jewel/js/inventory_in.js"></script>
    	<link rel="stylesheet" type="text/css" href="/jadrn019/jewel/css/menu.css" />
...
<body onunload="">
   <h3> <a href="/jadrn019/jsp/logout.jsp">Logout</a> </h3>  
	...
	<div id="navigation">
        <ul>
		<li class="buttons"><a id="current" href="/jadrn019/jsp/menu_in.jsp">Inventory In</a></li>
		<li class="buttons"><a  href="/jadrn019/jsp/menu_out.jsp">Inventory Out</a></li> 
...
<input type="button" value="Add In" id="submit" onclick="submitForm()" class="disabled"/>
</span>
