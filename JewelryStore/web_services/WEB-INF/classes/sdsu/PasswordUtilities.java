...
public class PasswordUtilities {
    private static final String passwordFileName =
        "/srv/tomcat/webapps/jadrn019/WEB-INF/classes/sdsu/passwords.dat";
   ...
   public static void main(String [] args) {
   	...
   	PasswordUtilities.addEntryToPasswordFile("jadrn019","aks");	
   	PasswordUtilities.addEntryToPasswordFile("amallika","aks");	
